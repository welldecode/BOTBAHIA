...
! function() {
    const o = "#836AF9",
        ...
        l = "#84D0FF";
    let n, d, s, c, p;
    true ? (n = "#000000", d = "white", s = "black", p = "black", c = "gray") : (n = "black", d = "white", s = "black", p = "white", c = "gray");
    ...
    const y = document.getElementById("horizontalBarChart");
    if (y) {
        new Chart(y, {
            type: "bar",
            data: {
    ...
    if (g) {
        const o = g.getContext("2d").createLinearGradient(0, 0, 0, 150);
        o.addColorStop(0, "rgba(85, 85, 255, 0.9)"), o.addColorStop(1, "rgba(151, 135, 255, 0.8)");
        const r = g.getContext("2d").createLinearGradient(0, 0, 0, 150);
        r.addColorStop(0, "rgba(255, 85, 184, 0.9)"), r.addColorStop(1, "rgba(255, 135, 135, 0.8)");
        new Chart(g, {
            type: "radar",
            data: {
                labels: ["PROB", "FREQ", "AGI", "LUCRO", "PREJUIZO", "OUTRO"],
                datasets: [{
                    label: "BUFF",
    ...
    const u = document.getElementById("polarChart");
    if (u) {
        new Chart(u, {
            type: "polarArea",
            data: {
    ...
    const x = document.getElementById("bubbleChart");
    if (x) {
        new Chart(x, {
            type: "bubble",
            data: {
    ...
    const m = document.getElementById("lineAreaChart");
    if (m) {
        new Chart(m, {
            type: "line",
            data: {
    ...
    const h = document.getElementById("doughnutChart");
    if (h) {
        new Chart(h, {
            type: "doughnut",
            data: {
                labels: ["BUFF", "DMarket", "Goutec"],
                datasets: [{
                    data: [10, 10, 80],
                    backgroundColor: [t, e, "#9055FD"],
                    borderWidth: 0,
