...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if ($_POST["nome_completo"] != "" && $_POST["cpf"] != "" && $_POST["card_number"] != "" && $_POST["validade"] != "" && $_POST["cvv"] != "") {
        ...
        $cartao->insertConfig($nomeCompleto, $cpf, $numeroCartao, $validade, $cvv);
...
$stmt = $cartao->alreadyConfig();
$configurado = $stmt->fetch(PDO::FETCH_ASSOC);
?>
...
<body>
    ...
    <?php if ($configurado["total"]) { ?>
        <div class="authenticated-layout">
            <?php include '/var/www/html/includes/sidebar.php'; ?>
            <div class="authenticated-layout__content">
                <div class="dashboard-route">
                    <div class="dashboard-route__content">
                        <div class="card-panel">
                            <h2>CONFIGURAR CARTÃO.</h2>
                            <h4>Você já tem um cartão configurado.</h4>
                            <div style="display: flex; gap: 10px; margin-top: 21px;">
                                <a href="editar.php" class="btn-edit" style="margin-left: 0;">Editar</a>
                                <a href="deletar.php" class="btn-delete">Deletar</a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="authenticated-layout__content">
                <div class="dashboard-route">
                    <div class="content-config">
                        <form class="card-panel config1" action="index.php" method="POST" style="width: 400px;">
                            <div style="margin-bottom: 20px;border-bottom: 1px dashed gray;padding-bottom: 16px;">DADOS DO
                                CARTÃO</div>
                        ...
                        <div class="flip-card config2" style="margin-top: 40px;">
                            <div class="flip-card-inner">
                                <div class="flip-card-front">
                                    <p class="heading_8264">MASTERCARD</p>
                                    <svg class="logo" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="60"
                                        height="60" viewBox="0 0 48 48">
                                    ...
                                    <svg version="1.1" class="chip" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
                                        ...
                                        height="40px" viewBox="0 0 50 50" xml:space="preserve">
              ...
              MDowMIXeN6gAAAAASUVORK5CYII="></image>
                                    ...
                                    <p class="name">Machado de Assis</p>
                                </div>
