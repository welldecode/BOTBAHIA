...
def fetch_api_data():
    ...
    if public_key and secret_key:
        ...
        api_url_path = "/exchange/v1/user/offers?side=user&orderBy=updated&orderDir=desc&title=&priceFrom=0&priceTo=0&treeFilters=&gameId=a8db&cursor=&limit=100&currency=USD&platform=browser"
        method = "GET"
...
@app.route('/set_user_keys', methods=['POST'])
def set_keys():
...
@app.route('/total_item_value', methods=['GET'])
